...
<Column2>
    <Column>
        <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-01.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
    </Column>

    <Column>
        <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-02.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
...
<Column2>
    <Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-typo.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
    ...
    <Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-colors.gif?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-posters-01.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-posters-02.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-dish-falcon-comics-04.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "dish-sling/tasveerien-website-falcon-wins-desktop-03.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=100 "a title")
</Column>

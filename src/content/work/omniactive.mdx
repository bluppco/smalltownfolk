...
<Column>
    <img
        src={ CDN_LINK + "omniactive/tasveerien-omniactive-xtracs-desktop.jpg?quality=" + IMAGE_QUALITY }
...
<Column>
    <img
        src={ CDN_LINK + "omniactive/tasveerien-omniactive-olixr-desktop.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80?quality=80&width=800 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "omniactive/tasveerien-omniactive-ogments-desktop.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80?quality=80&width=800 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "omniactive/tasveerien-website-omniactive-icons.gif?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80?quality=80&width=800 "a title")
...
<Column2>
    ...
    <Column>
        <img
        src={ CDN_LINK + "omniactive/small-town-folk-omniactive-colors.jpg?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80?quality=80&width=800 "a title")
...
<Column>
    <img
        src={ CDN_LINK + "omniactive/tasveerien-website-omniactive-eye.gif?quality=" + IMAGE_QUALITY }
        alt="amintiri a bake down memory lane"
        class="w-full h-full"
    />
    ![Alt text](https://blupp.b-cdn.net/smalltownfolk/?quality=80?quality=80&width=800 "a title")

...
<Column2>
    <Column>
        <div class="bg-zinc-200 flex justify-center items-center h-full">_VimeoVideo_</div>
    </Column>

    <Column>
        <img
            src={ CDN_LINK + "omniactive/small-town-folk-omniactive-colors.jpg?quality=" + IMAGE_QUALITY }
            alt="omniactive colors"
            class="w-full h-full"
        />
